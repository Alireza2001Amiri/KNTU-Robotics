...
smiData.RigidTransform(1).translation = [64.000000000000014 5 0];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [-49.999999999999986 5.0000000000000844 -2.6645352591003757e-15];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [0 100.00000000000001 4.9999999999999503];  % cm
smiData.RigidTransform(4).angle = 3.1415926535897927;  % rad
smiData.RigidTransform(4).axis = [-1 8.3817901308491255e-48 -2.1570415377137042e-32];
smiData.RigidTransform(4).ID = 'F[Link1-1:-:Cyliner-1]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [50.000000000000014 5.0000000000000009 -1.8369701987210301e-14];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [64.000000000000014 -5.0000000000000142 -3.0198066269804258e-14];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(7).translation = [-63.999999999999993 5 -2.2204460492503131e-14];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [50.000000000000043 4.9999999999999396 -6.1284310959308641e-14];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(9).translation = [-50.000000000000021 5 0];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(10).translation = [7.1054273576010019e-15 100.00000000000001 -5.0000000000000178];  % cm
smiData.RigidTransform(10).angle = 3.8003970556157801e-16;  % rad
smiData.RigidTransform(10).axis = [-0.27917772513849654 0.96023944815160245 -5.0940040380551462e-17];
smiData.RigidTransform(10).ID = 'F[Link2-1:-:Cyliner-1]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(11).translation = [-50.000000000000014 5 0];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(12).translation = [-67.500000000000014 -5.0000000000000435 -3.5527136788005009e-15];  % cm
smiData.RigidTransform(12).angle = 2.0943951023931948;  % rad
smiData.RigidTransform(12).axis = [-0.57735026918962618 -0.57735026918962551 -0.57735026918962562];
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(14).translation = [0 150 0];  % cm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(16).translation = [0 -100 0];  % cm
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 770.20154808587256;  % kg
smiData.Solid(2).CoM = [0.00015887974976505384 49.461334035063551 0.00028216588634644797];  % cm
smiData.Solid(2).MoI = [1144747.149455952 937424.94426358386 1092260.1750746709];  % kg*cm^2
smiData.Solid(2).PoI = [-4.753523548839544 -8.99992952979043 -8.8163666836776979];  % kg*cm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 21.570796326794902;  % kg
smiData.Solid(3).CoM = [0 0 0];  % m
smiData.Solid(3).MoI = [0.091514564202056739 2.2731102162248464 2.2175469792341143];  % kg*m^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 27.170796326794893;  % kg
smiData.Solid(4).CoM = [0 0 0];  % m
smiData.Solid(4).MoI = [0.11484789753539004 4.4083959766479781 4.3388327396572466];  % kg*m^2
...
smiData.RevoluteJoint(3).Rz.Pos = 90.000000000000057;  % deg
